# Documentação do Projeto: MobileMakers
...
O MobileMakers é um PWA (Progressive Web App) desenvolvido para criadores de conteúdo e gestores de tráfego que buscam imagens autênticas capturadas via dispositivos móveis. O foco não é a perfeição técnica de uma DSLR, mas a conexão real e o formato vertical nativo das redes sociais.
...
- **Slugs Semânticos:** URLs estruturadas como mobilemakers.app/foto/vertical-confeitaria-artesanal-iphone-15.
